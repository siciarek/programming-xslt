...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:tree-e="tree-e">


    <tree-e:tree-e />
    <xsl:variable name="tree-e" select="document('')/*/tree-e:*[1]" />
    <xsl:template name="tree-e" match="*[namespace-uri()='tree-e']">

        <xsl:param name="stage" select="0" />
        <xsl:param name="angle" select="20" />
