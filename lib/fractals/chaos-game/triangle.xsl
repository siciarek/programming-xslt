...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:chaos-game-triangle="chaos-game-triangle">

    <chaos-game-triangle:chaos-game-triangle />
    <xsl:variable name="chaos-game-triangle" select="document('')/*/chaos-game-triangle:*[1]" />
    <xsl:template name="chaos-game-triangle" match="*[namespace-uri()='chaos-game-triangle']">
        ...
        <xsl:param name="seed" />
            ...
            <xsl:variable name="by" select="$width div 2 + 52" />
            ...
            <xsl:call-template name="do-chaos-game-triangle">
                <xsl:with-param name="stage" select="$stage" />
                <xsl:with-param name="seed" select="$seed" />

				<xsl:with-param name="sides" select="3" />
				<xsl:with-param name="a" select="1 div 2" />
    ...
    <xsl:template name="do-chaos-game-triangle">
