...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:quadratic_koch_island_1_pg_13="quadratic_koch_island_1_pg_13">
...
<!--
	...
	File        : quadratic-koch-island-1-pg-13.xsl
	Procedure   : quadratic_koch_island_1_pg_13
	Created by  : Jacek Siciarek <siciarek@gmail.com>
	Created at  : 2012-03-26 20:16:23+00:00

	Description : Quadratic Koch Island 1 pg. 13

-->

	<quadratic_koch_island_1_pg_13:quadratic_koch_island_1_pg_13 />
	<xsl:variable name="quadratic_koch_island_1_pg_13" select="document('')/*/quadratic_koch_island_1_pg_13:*[1]" />
	<xsl:template name="quadratic_koch_island_1_pg_13" match="*[namespace-uri()='quadratic_koch_island_1_pg_13']">
	...
	<xsl:call-template name="quadratic_koch_island_1_pg_13F">
	...
	<xsl:template name="quadratic_koch_island_1_pg_13F">
    ...
    <xsl:template match="/">
		...
		<xsl:variable name="content">
             <xsl:call-template name="quadratic_koch_island_1_pg_13">
