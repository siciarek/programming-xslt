...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:spiral_tiling="spiral_tiling">
...
<!--
	...
	File        : spiral-tiling.xsl
	Procedure   : spiral_tiling
	Created by  : Jacek Siciarek <siciarek@gmail.com>
	Created at  : 2012-03-27 13:46:03+00:00

	Description : Spiral Tiling

-->

	<spiral_tiling:spiral_tiling />
	<xsl:variable name="spiral_tiling" select="document('')/*/spiral_tiling:*[1]" />
	<xsl:template name="spiral_tiling" match="*[namespace-uri()='spiral_tiling']">
	...
	<xsl:call-template name="spiral_tilingA">
	...
	<xsl:template name="spiral_tilingA">
		...
		<xsl:if test="$depth &gt; 0">		
		<xsl:call-template name="spiral_tilingX">
	...
	<xsl:template name="spiral_tilingX">
		...
		<xsl:if test="$depth &gt; 0">					<xsl:value-of select="concat('branchoff', ' hideturtle ')" />
		...
		<xsl:call-template name="spiral_tilingY">
			<xsl:with-param name="depth" select="$depth - 1" />
			<xsl:with-param name="angle" select="$angle" />
			<xsl:with-param name="size" select="$size" />
		</xsl:call-template>
	...
	<xsl:template name="spiral_tilingY">
    ...
    <xsl:template match="/">
		...
		<xsl:variable name="content">
             <xsl:call-template name="spiral_tiling">
                 <xsl:with-param name="depth" select="5" />
                 <xsl:with-param name="angle" select="15.000000" />
