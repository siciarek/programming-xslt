...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:koch_curve_b="koch_curve_b">
...
<!--
	...
	File        : koch-curve-b.xsl
	Procedure   : koch_curve_b
	Created by  : Jacek Siciarek <siciarek@gmail.com>
	Created at  : 2012-03-27 06:40:03+00:00

	Description : Koch Curve B

-->

	<koch_curve_b:koch_curve_b />
	<xsl:variable name="koch_curve_b" select="document('')/*/koch_curve_b:*[1]" />
	<xsl:template name="koch_curve_b" match="*[namespace-uri()='koch_curve_b']">
	...
	<xsl:call-template name="koch_curve_bF">
	...
	<xsl:template name="koch_curve_bF">
    ...
    <xsl:template match="/">
		...
		<xsl:variable name="content">
             <xsl:call-template name="koch_curve_b">
                 <xsl:with-param name="depth" select="3" />
                 <xsl:with-param name="angle" select="90" />
                 <xsl:with-param name="size" select="14.814814814815" />
                 <xsl:with-param name="xoffset" select="200" />
                 <xsl:with-param name="yoffset" select="200" />
             </xsl:call-template>
         </xsl:variable>
