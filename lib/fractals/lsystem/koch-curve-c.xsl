...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:koch_curve_c="koch_curve_c">
...
<!--
	...
	File        : koch-curve-c.xsl
	Procedure   : koch_curve_c
	Created by  : Jacek Siciarek <siciarek@gmail.com>
	Created at  : 2012-03-28 08:04:26+00:00

	Description : Koch Curve C

-->

	<koch_curve_c:koch_curve_c />
	<xsl:variable name="koch_curve_c" select="document('')/*/koch_curve_c:*[1]" />
	<xsl:template name="koch_curve_c" match="*[namespace-uri()='koch_curve_c']">
	...
	<xsl:call-template name="koch_curve_c_F">
	...
	<xsl:template name="koch_curve_c_F">
    ...
    <xsl:template match="/">
		...
		<xsl:variable name="content">
             <xsl:call-template name="koch_curve_c">
                 <xsl:with-param name="depth" select="3" />
                 <xsl:with-param name="angle" select="90.000000" />
                 <xsl:with-param name="size" select="22.000000" />
                 <xsl:with-param name="xoffset" select="-54.000000" />
                 <xsl:with-param name="yoffset" select="-164.000000" />
             </xsl:call-template>
         </xsl:variable>
