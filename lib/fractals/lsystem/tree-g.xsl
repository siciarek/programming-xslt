...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:tree_g="tree_g">
...
<!--
	...
	Created at  : 2012-03-27 13:42:03+00:00
...
-->
	...
	<tree_g:tree_g />
	<xsl:variable name="tree_g" select="document('')/*/tree_g:*[1]" />
	<xsl:template name="tree_g" match="*[namespace-uri()='tree_g']">
	...
	<xsl:call-template name="tree_gF">
