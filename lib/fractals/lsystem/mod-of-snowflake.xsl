...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:mod_of_snowflake="mod_of_snowflake">
...
<!--
	...
	File        : mod-of-snowflake.xsl
	Procedure   : mod_of_snowflake
	Created by  : Jacek Siciarek <siciarek@gmail.com>
	Created at  : 2012-03-27 12:25:11+00:00

	Description : Mod of snowflake

-->

	<mod_of_snowflake:mod_of_snowflake />
	<xsl:variable name="mod_of_snowflake" select="document('')/*/mod_of_snowflake:*[1]" />
	<xsl:template name="mod_of_snowflake" match="*[namespace-uri()='mod_of_snowflake']">
	...
	<xsl:call-template name="mod_of_snowflakeF">
	...
	<xsl:template name="mod_of_snowflakeF">
    ...
    <xsl:template match="/">
		...
		<xsl:variable name="content">
             <xsl:call-template name="mod_of_snowflake">
                 <xsl:with-param name="depth" select="4" />
                 <xsl:with-param name="angle" select="90.000000" />
                 <xsl:with-param name="size" select="6.320988" />
