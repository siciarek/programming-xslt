...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:e_curve="e_curve">
...
<!--
	...
	Created at  : 2012-03-28 07:53:02+00:00
...
-->
	...
	<e_curve:e_curve />
	<xsl:variable name="e_curve" select="document('')/*/e_curve:*[1]" />
	<xsl:template name="e_curve" match="*[namespace-uri()='e_curve']">
	...
	<xsl:call-template name="e_curve_Fr">
	...
	<xsl:template name="e_curve_Fl">
		...
		<xsl:if test="$depth &gt; 0">		
		<xsl:call-template name="e_curve_Fl">
    ...
    <xsl:template match="/">
		...
		<xsl:variable name="content">
             <xsl:call-template name="e_curve">
