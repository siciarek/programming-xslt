...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:quadratic_koch_island_2="quadratic_koch_island_2">
...
<!--
	...
	File        : quadratic-koch-island-2.xsl
	Procedure   : quadratic_koch_island_2
	Created by  : Jacek Siciarek <siciarek@gmail.com>
	Created at  : 2012-03-26 21:30:36+00:00

	Description : Quadratic Koch Island 2 pg. 14

-->

	<quadratic_koch_island_2:quadratic_koch_island_2 />
	<xsl:variable name="quadratic_koch_island_2" select="document('')/*/quadratic_koch_island_2:*[1]" />
	<xsl:template name="quadratic_koch_island_2" match="*[namespace-uri()='quadratic_koch_island_2']">
	...
	<xsl:call-template name="quadratic_koch_island_2F">
	...
	<xsl:template name="quadratic_koch_island_2F">
    ...
    <xsl:template match="/">
		...
		<xsl:variable name="content">
             <xsl:call-template name="quadratic_koch_island_2">
