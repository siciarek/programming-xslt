...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:tree_a="tree_a">
...
<!--
	...
	Created at  : 2012-03-27 13:41:26+00:00
...
-->
	...
	<tree_a:tree_a />
	<xsl:variable name="tree_a" select="document('')/*/tree_a:*[1]" />
	<xsl:template name="tree_a" match="*[namespace-uri()='tree_a']">
	...
	<xsl:call-template name="tree_aF">
