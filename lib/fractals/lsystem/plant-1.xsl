...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:plant_1="plant_1">
...
<!--
	...
	Created at  : 2012-03-28 07:57:16+00:00
...
-->
	...
	<plant_1:plant_1 />
	<xsl:variable name="plant_1" select="document('')/*/plant_1:*[1]" />
	<xsl:template name="plant_1" match="*[namespace-uri()='plant_1']">
	...
	<xsl:call-template name="plant_1_0">
	...
	<xsl:template name="plant_1_0">
		...
		<xsl:if test="$depth &gt; 0">		
		<xsl:call-template name="plant_1_1">
		...
		<xsl:call-template name="plant_1__branchoff">
			<xsl:with-param name="depth" select="$depth - 1" />
			<xsl:with-param name="angle" select="$angle" />
			<xsl:with-param name="size" select="$size" />
		</xsl:call-template>
		...
		<xsl:call-template name="plant_1__restore">
			<xsl:with-param name="depth" select="$depth - 1" />
			<xsl:with-param name="angle" select="$angle" />
			<xsl:with-param name="size" select="$size" />
		</xsl:call-template>
	...
	<xsl:template name="plant_1__branchoff">
	...
	<xsl:template name="plant_1__restore">
