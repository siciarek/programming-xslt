...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:spiral_curve="spiral_curve">
...
<!--
	...
	File        : spiral-curve.xsl
	Procedure   : spiral_curve
	Created by  : Jacek Siciarek <siciarek@gmail.com>
	Created at  : 2012-03-26 21:17:47+00:00

	Description : Spiral Curve

-->

	<spiral_curve:spiral_curve />
	<xsl:variable name="spiral_curve" select="document('')/*/spiral_curve:*[1]" />
	<xsl:template name="spiral_curve" match="*[namespace-uri()='spiral_curve']">
	...
	<xsl:call-template name="spiral_curve6">
	...
	<xsl:template name="spiral_curve6">
		...
		<xsl:if test="$depth &gt; 0">		
		<xsl:call-template name="spiral_curve7">
	...
	<xsl:template name="spiral_curve7">
		...
		<xsl:call-template name="spiral_curve8">
			<xsl:with-param name="depth" select="$depth - 1" />
			<xsl:with-param name="angle" select="$angle" />
			<xsl:with-param name="size" select="$size" />
		</xsl:call-template>
	...
	<xsl:template name="spiral_curve8">
    ...
    <xsl:template match="/">
		...
		<xsl:variable name="content">
             <xsl:call-template name="spiral_curve">
                 <xsl:with-param name="depth" select="4" />
                 <xsl:with-param name="angle" select="15" />
