...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:quadratic_koch_island_1="quadratic_koch_island_1">
...
<!--
	...
	File        : quadratic-koch-island-1.xsl
	Procedure   : quadratic_koch_island_1
	Created by  : Jacek Siciarek <siciarek@gmail.com>
	Created at  : 2012-03-26 21:22:09+00:00

	Description : Quadratic Koch Island 1

-->

	<quadratic_koch_island_1:quadratic_koch_island_1 />
	<xsl:variable name="quadratic_koch_island_1" select="document('')/*/quadratic_koch_island_1:*[1]" />
	<xsl:template name="quadratic_koch_island_1" match="*[namespace-uri()='quadratic_koch_island_1']">
	...
	<xsl:call-template name="quadratic_koch_island_1F">
	...
	<xsl:template name="quadratic_koch_island_1F">
    ...
    <xsl:template match="/">
		...
		<xsl:variable name="content">
             <xsl:call-template name="quadratic_koch_island_1">
