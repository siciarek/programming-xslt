...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:anklets_of_krishna="anklets_of_krishna">
...
<!--
	...
	File        : anklets-of-krishna.xsl
	Procedure   : anklets_of_krishna
	Created by  : Jacek Siciarek <siciarek@gmail.com>
	Created at  : 2012-03-27 13:59:24+00:00

	Description : Anklets of Krishna

-->

	<anklets_of_krishna:anklets_of_krishna />
	<xsl:variable name="anklets_of_krishna" select="document('')/*/anklets_of_krishna:*[1]" />
	<xsl:template name="anklets_of_krishna" match="*[namespace-uri()='anklets_of_krishna']">
	...
	<xsl:call-template name="anklets_of_krishnaX">
	...
	<xsl:template name="anklets_of_krishnaX">
    ...
    <xsl:template match="/">
		...
		<xsl:variable name="content">
             <xsl:call-template name="anklets_of_krishna">
                 <xsl:with-param name="depth" select="5" />
                 <xsl:with-param name="angle" select="45.000000" />
                 <xsl:with-param name="size" select="11.000000" />
                 <xsl:with-param name="xoffset" select="-240.000000" />
