...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:tree_d="tree_d">
...
<!--
	...
	Created at  : 2012-03-27 13:29:24+00:00
...
-->
	...
	<tree_d:tree_d />
	<xsl:variable name="tree_d" select="document('')/*/tree_d:*[1]" />
	<xsl:template name="tree_d" match="*[namespace-uri()='tree_d']">
	...
	<xsl:call-template name="tree_dF">
