...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:tree_ex="tree_ex">
...
<!--
	...
	Created at  : 2012-03-27 13:31:04+00:00
...
-->
	...
	<tree_ex:tree_ex />
	<xsl:variable name="tree_ex" select="document('')/*/tree_ex:*[1]" />
	<xsl:template name="tree_ex" match="*[namespace-uri()='tree_ex']">
	...
	<xsl:call-template name="tree_exX">
    ...
    <xsl:template match="/">
		...
		<xsl:variable name="content">
             <xsl:call-template name="tree_ex">
